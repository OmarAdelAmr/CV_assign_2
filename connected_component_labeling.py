...
def question_1_connected_component_labeling_l1(input_image):
    # l1_image = cv.imread("plates/originals/L1.jpg", 0)
    l1_image = input_image
    l1_binary_image = convert_to_binary(l1_image)
...
def question_1_connected_component_labeling_l3(input_image):
    # l3_gray_image = cv.imread("plates/originals/L3_gray_front.jpg", 0)
    # l3_gray_image = cv.imread("plates/L3_front.png", 0)
    l3_gray_image = input_image
...
# L = [(1, 2, 3, 8), (4,), (1, 3), (2, 3), (4, 5, 8), (5, 6,), (6, 7,),(10,)]
